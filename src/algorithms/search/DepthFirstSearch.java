...
//                this.setNumberOfNodesEvaluated(visited);
//
...
//            }
//
//            List<AState> possibleMoves = searchable.getValidStates(currentState);
//            for (AState move : possibleMoves) {
//                if (!move.validState() || searchable.isVisited(move)) {
//                    continue;
//                }
//                stack.push(move);
//                searchable.setVisited(move);
//                visited++;
//            }
//        }
//
